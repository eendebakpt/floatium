...
char* d2fixed(double d, uint32_t precision) {
  // See d2fixed_buffered_size in ryu.h.
  char* const buffer = (char*)malloc(d2fixed_buffered_size(precision));
...
char* d2exp(double d, uint32_t precision) {
  // See d2exp_buffered_size in ryu.h.
  char* const buffer = (char*)malloc(d2exp_buffered_size(precision));
